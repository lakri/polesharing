"""
Django settings for polesharing project.
...
SECRET_KEY = 'django-insecure-_$2eg1@5(gt9lh(24pxev#$0einb_4ei77ae*ezngmu4y=c&o%'
...
WSGI_APPLICATION = 'polesharing.wsgi.application'
